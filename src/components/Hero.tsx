  ...
  return (
    <section className="relative bg-gradient-to-br from-snack-accent to-white py-20 px-4 overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        <h1 className="text-6xl md:text-8xl font-black text-snack-dark mb-6 animate-fade-in tracking-tighter">
        ...
        <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto animate-slide-up leading-relaxed">
